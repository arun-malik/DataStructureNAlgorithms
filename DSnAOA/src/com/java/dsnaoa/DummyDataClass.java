...
public class DummyDataClass {
	...
	public static int[] AvgCase = {12,30,5,44,22,1,6,43};
	
	public static int[] RepeatingArray = {1,30,4,44,2,1,4,43};
	...
	public static void printOutPut(long[] fibArray, String message) {
		System.out.println("*******************"+message+"***********************");
		System.out.print("array value : ");
